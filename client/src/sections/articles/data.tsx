...
export const articles: Props[] = [
  {
    ...
    quote:
      '"I just read this amazing introduction to Chakra UI by Joshua Hall. I can\'t find you on twitter but I\'ll like to say "Thank you" for this 💖 . Check it out: 👇🏼" - Segun Adebayo (Chakra Lead Dev)',
  ...
  },
  {
    ...
    quote:
      '"Great write-up! We\'re testing Tina Teams (editing for non-tech folks) internally right now." - TinaCMS',
  ...
  },
  {
    ...
    desc: 'Learn how to create one of the most common data structures for managing intelligent queues: binary heaps. Well use JavaScript to go over the concepts.',
    quote: 'Most read article with over 350K views! 🚀',
